        ...
        <div class="page-header page-header-default">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Danh
                        sách các phòng trọ</h4>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Danh sách các phòng trọ <span
                                        class="badge badge-primary">{{$motelrooms->count()}}</span></h5>
                        </div>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @if($room->approve == 1)
                                                        <li><a href="admin/motelrooms/unapprove/{{$room->id}}"><i
                                                                        class="icon-file-pdf"></i> Bỏ kiểm duyệt</a>
                                                        </li>
                                                    @elseif($room->tinhtrang == 0)
                                                        <li><a href="admin/motelrooms/approve/{{$room->id}}"><i
                                                                        class="icon-file-pdf"></i> Kiểm duyệt</a></li>
                                                    @endif

                                                    <li><a href="admin/motelrooms/del/{{$room->id}}"><i
                                                                    class="icon-file-excel"></i> Xóa</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
